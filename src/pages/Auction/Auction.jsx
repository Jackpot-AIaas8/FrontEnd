          ...
          >
            <Grid size={4}>
              <StyledTypography  variant="h4" component="h2">
                ...
                <hr style={{ height: "3px", background: "black", margin:"30px auto 30px auto" }} />
              <StyledTypography  variant="h4" component="h2">실시간 경매</StyledTypography >
              <hr style={{ height: "3px", background: "black",marginTop:"30px auto 30px auto" }} />
            </Grid>
            <Grid size={8}>
              <AuctionCarousel />
            </Grid>
